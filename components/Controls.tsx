        ...
        {!isCompleted ? (
          <>
            ...
            <button
              ...
              className="px-6 h-14 bg-violet-400 text-white font-bold rounded-full shadow-lg hover:bg-violet-500 transform hover:scale-105 transition-all duration-300 ease-in-out text-lg flex items-center space-x-2"
